...
const VERSICULOS_DIARIOS = [
  { texto: "O temor do Senhor é o princípio do conhecimento.", referencia: "Provérbios 1:7" },
  { texto: "Instrui o menino no caminho em que deve andar.", referencia: "Provérbios 22:6" },
  { texto: "Se alguém necessita de sabedoria, peça-a a Deus, que a todos dá generosamente.", referencia: "Tiago 1:5" },
  { texto: "Ensina-me o bom senso e o conhecimento, pois confio em teus mandamentos.", referencia: "Salmos 119:66" },
  { texto: "O coração do sábio adquire o conhecimento, e o ouvido dos sábios busca aprender.", referencia: "Provérbios 18:15" },
  { texto: "Porque o Senhor dá a sabedoria; de sua boca procedem o conhecimento e o entendimento.", referencia: "Provérbios 2:6" },
  { texto: "Feliz é aquele que encontra sabedoria e adquire entendimento.", referencia: "Provérbios 3:13" },
  { texto: "O sábio de coração aceita os mandamentos.", referencia: "Provérbios 10:8" },
  { texto: "Quem ama a disciplina ama o conhecimento.", referencia: "Provérbios 12:1" },
  { texto: "O ensino do sábio é fonte de vida.", referencia: "Provérbios 13:14" },
  { texto: "O coração entendido busca o conhecimento.", referencia: "Provérbios 15:14" },
  { texto: "Adquirir sabedoria é melhor do que o ouro; adquirir entendimento é melhor do que a prata.", referencia: "Provérbios 16:16" },
  { texto: "Aplica o coração ao ensino e os ouvidos às palavras do conhecimento.", referencia: "Provérbios 23:12" },
  { texto: "Com a sabedoria se edifica a casa, e com o entendimento ela se estabelece.", referencia: "Provérbios 24:3" },
  { texto: "O sábio ouvirá e crescerá em conhecimento.", referencia: "Provérbios 1:5" },
  { texto: "Não deixe a sabedoria afastar-se dos seus olhos; guarde o bom senso e a prudência.", referencia: "Provérbios 3:21" },
  { texto: "Guarde o meu ensino como a menina dos seus olhos.", referencia: "Provérbios 7:2" },
  { texto: "Dá instrução ao sábio, e ele se tornará ainda mais sábio.", referencia: "Provérbios 9:9" },
  { texto: "Os lábios dos sábios espalham o conhecimento.", referencia: "Provérbios 15:7" },
  { texto: "O que adquire entendimento ama a sua própria vida.", referencia: "Provérbios 19:8" },
  { texto: "Ensina-me o teu caminho, Senhor, e guia-me por uma vereda segura.", referencia: "Salmos 27:11" },
  { texto: "Faze-me conhecer os teus caminhos; ensina-me as tuas veredas.", referencia: "Salmos 25:4" },
  { texto: "Ensina-nos a contar os nossos dias, para alcançarmos coração sábio.", referencia: "Salmos 90:12" },
  { texto: "A revelação das tuas palavras esclarece e dá entendimento aos simples.", referencia: "Salmos 119:130" },
  { texto: "O Espírito Santo vos ensinará todas as coisas.", referencia: "João 14:26" },
  { texto: "Ensinem estas palavras aos seus filhos, falando delas em casa e pelo caminho.", referencia: "Deuteronômio 11:19" },
  { texto: "Estas palavras estarão no teu coração; tu as ensinarás com dedicação aos teus filhos.", referencia: "Deuteronômio 6:6–7" },
  { texto: "Tudo o que é verdadeiro, respeitável e justo, seja isso o que ocupe o pensamento de vocês.", referencia: "Filipenses 4:8" },
  { texto: "Procure apresentar-se a Deus aprovado, manejando corretamente a palavra da verdade.", referencia: "2 Timóteo 2:15" },
  { texto: "Toda a Escritura é útil para ensinar, repreender, corrigir e instruir na justiça.", referencia: "2 Timóteo 3:16" },
