...
export default function Landing() {
  ...
  return <main className="gl-site">
    ...
    <section className="gl-hero"><div className="gl-orbit one"/><div className="gl-orbit two"/><Logo/><h1>Atividades que<br/><em>entendem cada aluno.</em></h1><p>Crie, adapte e organize experiências pedagógicas com inteligência — sem abrir mão do seu olhar.</p><div className="gl-actions"><button onClick={() => document.querySelector('#experiencia')?.scrollIntoView({ behavior: 'smooth' })}>Conhecer a experiência ↓</button><button onClick={goToCreator}>Criar uma atividade</button></div><small className="gl-scroll">ROLE PARA DESCOBRIR</small></section>
